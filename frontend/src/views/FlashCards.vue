<template>
    <div v-for="(deck, index) in this.$store.state.deck.decks" v-bind:key="deck.id">
        ...
        <div class="card mx-5" style="width: 18rem; background-color: whitesmoke">
            <div class="card-body" style="background-colour:{{deck.colour}}">
                ...
                <ul class="list-group" v-show="this.showOptions[index]">
                    ...
                    <li class="list-group-item d-grid gap-2">
                        <button type="button" class="btn btn-outline-primary dropdown-toggle" data-bs-toggle="collapse"
