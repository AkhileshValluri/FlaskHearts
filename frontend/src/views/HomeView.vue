...
<![endif]-->
    ...
    <body class="clean-body u_body"
        style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f9f9f9;color: #000000; width:100%">
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding-right: 0px;padding-left: 0px;"
                                                                                ...
                                                                                <img align="center" border="0"
                                                                                    src="https://assets.unlayer.com/projects/90824/1658254047030-684923.png"
                                                                                    alt="" title=""
                                                            ...
                                                            <tr>
                                                                <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                style="font-size: 22px; line-height: 35.2px;">Welcome
                                                                                to FlaskHearts! This is a place where
                                                                                you
                                                                                can make a revise flashcards. </span>
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;"> 
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                ...
                                                                                can segregate flashcards on the same
                                                                                topic
                                                                                into decks. Each deck can have multiple
                                                                                flashcards.</span>
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;"> 
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                style="font-size: 22px; line-height: 35.2px;">When
                                                                                reviewing flashcards you will be able to
                                                                                select how difficult each one was.
                                                                                Without
                                                                                seeing the backside of the
                                                                                flashcard. </span>
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;"> 
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                style="font-size: 22px; line-height: 35.2px;">Your
                                                                                score will be updated for each deck. You
                                                                                will be able to review these statistics
                                                                                on
                                                                                the dashboard. </span>
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;"> 
                                                                        ...
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                style="font-size: 22px; line-height: 35.2px;">We
                                                                                will also send you monthly reports and
                                                                                daily
                                                                                reminders. </span>
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                style="font-size: 22px; line-height: 35.2px;">You
                                                                                can export and import decks in the form
                                                                                of
                                                                                csv, html formats. </span>
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;"> 
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                style="font-size: 22px; line-height: 35.2px;">Have
                                                                                fun! Happy revising!</span>
                                                                        </p>
                                                                        <p style="font-size: 14px; line-height: 160%;"> 
                                                                        </p>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="line-height: 160%; font-size: 14px;">
                                                                            <span
                                                                                style="font-size: 18px; line-height: 28.8px;">Akhilesh
                                                                                Kaushik Valluri</span>
                                                                        </p>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="font-size: 14px; line-height: 160%;">
                                                                            <span
                                                                                style="font-size: 16px; line-height: 25.6px; color: #000000;">akhilesh.k.valluri@gmail.com</span>
                                                                        </p>
                                                                    </div>
